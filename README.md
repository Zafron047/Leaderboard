...
**[Leaderboard]** is a project that we have developed to showcase our skills in DOM Manipulation and Dynamic Functionality application. I have further Enhanced it with introduction to modules and modern ES6 functionalities.
...
```shell
cd my-folder
git clone https://github.com/Zafron047/Leaderboard.git
```
### Install
...
Feel free to check the [issues page](https://github.com/Zafron047/Leaderboard/issues).
